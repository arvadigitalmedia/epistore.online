            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4 flex gap-4">
                        <form method="GET" action="{{ route('distributor.orders.index') }}" class="flex gap-2 w-full">
                            <input type="text" name="search" placeholder="Search Order No or Customer" value="{{ request('search') }}" class="rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 w-1/3">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('distributor.orders.show', $order) }}" class="text-primary-600 hover:text-primary-900">View</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
